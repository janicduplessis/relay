...
function getCodegenRunner(config) {
  ...
  var writerConfigs = (0, _defineProperty2["default"])({}, sourceWriterName, {
    writeFiles: getRelayFileWriter(config.src, languagePlugin, config.noFutureProofEnums, artifactDirectory, config.persistOutput, config.customScalars, persistQueryFunction, config.includePersistedQueryTextInDev, config.repersist),
...
function getRelayFileWriter(baseDir, languagePlugin, noFutureProofEnums, outputDir, persistedQueryPath, customScalars, persistFunction, includePersistedQueryTextInDev, repersist) {
  return (
    /*#__PURE__*/
    function () {
